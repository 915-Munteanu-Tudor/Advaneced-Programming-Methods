...
public class ForkStmt implements IStmt{
    ...
    private static IDict<String, IType> clone(IDict<String, IType> stbl) throws InterpreterException {
        IDict<String, IType> newStbl = new Dict<>();
        for (Map.Entry<String, IType> entry : stbl.getContent().entrySet()) {
            newStbl.add(entry.getKey(), entry.getValue());
        }
        return newStbl;
    }
