...
public class Main {
    ...
    public static void main(String[] args) throws InterpreterException {
        ...
        try {
            ...
            state7= new PrgState(new Stack<>(), new Dict<>(), new List<>(), new Dict<>(), new Heap<>(), ex7, new LatchTable<>());
            ...
            state6= new PrgState(new Stack<>(), new Dict<>(), new List<>(), new Dict<>(), new Heap<>(), ex6, new LatchTable<>());
            ...
            state5 = new PrgState(new Stack<>(), new Dict<>(), new List<>(), new Dict<>(), new Heap<>(), ex5, new LatchTable<>());
            ...
            state4 = new PrgState(new Stack<>(), new Dict<>(), new List<>(), new Dict<>(), new Heap<>(), ex4, new LatchTable<>());
            ...
            IStmt ex3 = new CompStmt(new VarDeclStmt("a", new BoolType()), new CompStmt(new VarDeclStmt("v",
                    ...
                    new CompStmt(new IfStmt(new VarExp("a"), new AssignStmt("v", new ValueExp(new IntValue(2))),
                            ...
                            VarExp("v"))))));
            state3 = new PrgState(new Stack<>(), new Dict<>(), new List<>(), new Dict<>(), new Heap<>(), ex3, new LatchTable<>());
            ...
            IStmt ex2 = new CompStmt(new VarDeclStmt("v", new IntType()),
                    new CompStmt(new AssignStmt("v", new ValueExp(new IntValue(2))),
                            new PrintStmt(new VarExp("v"))));
            state2 = new PrgState(new Stack<>(), new Dict<>(), new List<>(), new Dict<>(), new Heap<>(), ex2, new LatchTable<>());
            ...
            state1 = new PrgState(new Stack<>(), new Dict<>(), new List<>(), new Dict<>(), new Heap<>(), ex1, new LatchTable<>());
